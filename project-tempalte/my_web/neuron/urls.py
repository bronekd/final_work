...
from .views import ImagePredictionFilterView, model_name_autocomplete, description_autocomplete, predicted_class_autocomplete
...
urlpatterns = [
    ...
    path('description-autocomplete/', description_autocomplete, name='description_autocomplete'),
    path('predicted-class-autocomplete/', predicted_class_autocomplete, name='predicted_class_autocomplete'),
]
